...
#where do i want to send who go to the this route---> include 'blog.urls'
urlpatterns = [
    path('admin/', admin.site.urls),
    path('register/', user_views.register, name='register'),
    path('profile/', user_views.profile, name='profile'),
    path('profile/<int:pk>',user_views.AuthorDetailView.as_view(),name='author-detail'),
    ...
    path('authors/',user_views.AuthorListView.as_view(),name='list-author')
]
